...
settings.get().then(set => {
    ...
    document.getElementById("knuplus_inputbutton_id").addEventListener("click", (event) => {
        const idInput = document.getElementById("knuplus_input_id");
        id = idInput.value;
    ...
    document.getElementById("knuplus_inputbutton_password").addEventListener("click", async (event) => {
        const passwordInput = document.getElementById("knuplus_input_password");
